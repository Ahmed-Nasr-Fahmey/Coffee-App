...
class ColdCoffeeDrinksView extends StatelessWidget {
  const ColdCoffeeDrinksView({super.key});
  static const String routeName = 'ColdCoffeeDrinksView';
  @override
        ...
        child: Column(
          children: [
            ...
            CustomCategoriesProductCardBuilder(
              productsList: ConstModels.coldCoffeeDrinksModels,
            ),
          ],
        ),
      ),
